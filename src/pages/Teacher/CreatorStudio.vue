            ...
            <md-layout md-flex-xsmall="50" md-flex-small="50" md-flex-medium="33" md-flex-large="25"
                ...
                <md-card class="sect md-whiteframe-7dp" style="min-height: 600px">
                    <md-list>
                        ...
                        <md-list-item :class="{'active':activeItem === 'data_center'}" @click="routerPush('data_center'); activeItem = 'data_center'">
...
<script>
    import DataCenter from '../../components/CreatorStudio/DataCenter'
