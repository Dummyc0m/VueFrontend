<template>
    <div class="container">
        <QuestionCard :section="section" :number="number" content="二三十年<latex>\int \left(x^2+ax-3\right)^2dx</latex>">
            <multiple-choice-content v-model="selected" :choices="choices"></multiple-choice-content>
        </QuestionCard>
        {{selected}}
